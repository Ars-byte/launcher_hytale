...
class HytaleLauncher(ctk.CTk):
    def __init__(self):
        ...
        # --- FIX CRÍTICO DE RUTAS PARA NUITKA/PYINSTALLER ---
        if getattr(sys, 'frozen', False) or '__compiled__' in globals():
            # Si es un binario, la ruta base es donde está el ejecutable real (.bin)
        ...
        # Carga de imagen usando la ruta base corregida
    ...
    def launch(self):
        ...
        if os.path.exists(script_path):
            ...
            try:
                # Se lanza usando la ruta base corregida
